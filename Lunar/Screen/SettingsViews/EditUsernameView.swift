...
struct EditUsernameView: View {
    ...
    func saveText() {
        ...
        UserDefaults.standard.setValue(message, forKey: "username")
        ...
        AuthService.instance.updateUserUsername(userID: userID, username: message) { success in
...
struct EditUsernameView_Previews: PreviewProvider {
    static var previews: some View {
        EditUsernameView(title: "@Username", placeholder: "Username here")
    }
}
